...
df = pd.read_csv(r'C:\Users\snigd\OneDrive\Desktop\SEO\Datasets\electricity_data.csv')
df = df[1110:]
df.reset_index(drop=True, inplace=True)
df.index = pd.to_datetime(df['Date'])

df2 = pd.read_csv(r'C:\Users\snigd\OneDrive\Desktop\SEO\Datasets\electrical_appliance_consumption.csv')
df2 = df2[df2['year'] == 2021]
df2.reset_index(drop=True, inplace=True)

df3 = pd.read_csv(r'C:\Users\snigd\OneDrive\Desktop\SEO\Datasets\electrical_forecast.csv')

df4 = pd.read_csv(r'c:\Users\snigd\OneDrive\Desktop\SEO\Datasets\electricity_appliance_wise_data.csv')
